...
export const StatisticRenderDateStrategy: FunctionComponent<IStatisticRenderStrategyProps> = (
  props
) => {
...
export default StatisticRenderDateStrategy;
